Файл README.md успешно создан по указанному пути: C:/Users/Николай/IdeaProjects/Administrator Jhrana/README.md.

Что было сделано для подготовки файла:

Структура: Текст разбит на логические блоки с использованием заголовков Markdown (#, ##), что обеспечивает удобную навигацию.
Оформление: Добавлены эмодзи в названиях разделов, таблицы (для API и параметров фильтрации) оформлены через синтаксис GitHub Flavored Markdown. Блоки кода обернуты в тройки обратных кавычек с указанием языка (bash, http, yaml) для корректной подсветки синтаксиса.
Контент: Сохранена вся предоставленная вами информация — от описания проекта до инструкций по сборке Docker-образа.

Содержимое готово к коммиту в систему контроля версий (Git) или открытию в любом текстовом редакторе. Вы можете скопировать его ниже:

<details>
<summary><strong>Показать содержимое README.md</strong></summary>
<br>
